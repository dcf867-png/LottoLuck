...
export default function ScoringKey({ drawCount }: Props) {
  return (
    <section className="panel">
      ...
      <div className="border-t border-white/10 pt-3 flex flex-col gap-1 text-center">
        <span className="text-[11px] text-white/70">{drawCount} current-era draws analysed · data via NY Open Data</span>
        <span className="text-[11px] text-white/50">For entertainment purposes only.</span>
      </div>
    </section>
  )
}
